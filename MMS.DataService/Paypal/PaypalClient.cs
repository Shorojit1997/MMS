...
namespace MMS.DataService.Paypal
{
    public sealed class PaypalClient
    {
        ...
        public async Task<CreateOrderResponse> CreateOrder(string value, string currency)
        {
            ...
            var request = new CreateOrderRequest
            {
                ...
                {
                   return_url = "https://localhost:44324/Paypal/Capture",
                   cancel_url = "https://localhost:44324/Cancel"
                }
